...
/// ***************** 
//const uri = "mongodb://localhost:27017/atn"
const uri = "mongodb+srv://1:1@cluster0-kkftl.mongodb.net/atn?retryWrites=true&w=majority";

//const urirem = "mongodb+srv://1:1@cluster0-kkftl.mongodb.net/atn?retryWrites=true&w=majority";
//const urixx = "mongodb+srv://1:1@cluster0-kkftl.mongodb.net/atn?retryWrites=true&w=majority";
...
function viewProduct(request, response) {
    ...
    if (xflag == 0) {
        readDB();
        response.send("Web - products Catalog page !" + stt);
    } else {
...
function viewPayment(request, response) {
    ...
    for (i=0; i< listkq.length / 2; i++) {
        listsp.push(
            { Name : "/ " + listkq[i*2], Price : ".", Num: listkq[i*2+1]},
        );
    }
